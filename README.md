...
The web layer uses `web/data-adapter.js` to convert the nested canonical schema plus the coordinate and batch overlays into display view-models. Unknown values are legal and render as `未研究`, `unknown`, or `L1 pending`.
